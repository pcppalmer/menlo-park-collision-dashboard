...
Built with **MapLibre GL JS** and **Chart.js**, the application combines open source interactive web mapping with linked data visualizations that allow users to explore collision patterns by year, transportation mode, and injury severity.
